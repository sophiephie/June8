...
public class MyProgram2_AddSubMultDivMod {
	...
	public static void main(String[] args) {
		...
		val1 = kb.nextInt();
		System.out.println("Please give me a second int num ");
		val2 = kb.nextInt();
		System.out.println("Your first integer is " + val1);
		System.out.println("Your second interger is " + val2);
		System.out.println("=====================");
		...
		dval1 = kb.nextDouble();
		System.out.println("Please give me a second double num ");
		dval2 = kb.nextDouble();
